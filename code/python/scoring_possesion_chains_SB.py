...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 17:01:20 2021
...
with open('../../../Datasets/statsbomb/data/events/'+file_name) as data_file:
...
relevand_possessions = match_events[(match_events['type_id'] == 16)][(match_events['shot_outcome_name'] == 'Goal')]['possession'].unique()  # all uniques possessions with shot
